...
<samp>Jr Cloud Analyst with a strong interest in networking, security, and systems engineering. Currently diving deeper into Go, observability (OTel, Prometheus, Grafana, Zabbix) and IaC (Terraform, CloudFormation).
</samp>
