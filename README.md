...
<samp>DevOps Intern with a strong interest in networking, security, and systems engineering. Currently diving deeper into Go, observability tools (Grafana, Prometheus, Zabbix) and IaC (Terraform, CloudFormation).
</samp>
